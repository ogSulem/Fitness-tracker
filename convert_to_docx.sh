...
#   • Таблицы: подпись сверху («Таблица N. Название»), выравнивание по правому краю
#   • Рисунки: подпись снизу по центру («Рисунок N. Название»), без точки в конце
#   • Цитирование: кавычки «»; ссылки в квадратных скобках [N]
#   • Список литературы: алфавитный порядок (сначала русские, потом иностранные)
