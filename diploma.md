...
4. Реализован персонализированный алгоритм расчета индивидуальной суточной нормы калорий на основе формулы Миффлина–Сан Жеора (формулы 3.1–3.3): BMR = 10×m + 6,25×h − 5×a ± 5/161, TDEE = BMR × Ka, корректировка по цели: −500/0/+300 ккал — с учетом уровня активности и цели пользователя [2].
