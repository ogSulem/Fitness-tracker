...
3. Реализовать полнофункциональное веб-приложение, включая персонализированный алгоритм расчета суточной нормы калорий по формуле Миффлина–Сан Жеора, безопасную систему аутентификации на JWT и модуль визуализации и аналитики с экспортом данных;
